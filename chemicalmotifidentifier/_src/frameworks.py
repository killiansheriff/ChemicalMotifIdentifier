...
from .dataset import *
from .frameworks_base import ECA_MD, ECA_Synthetic

# Model used in https://arxiv.org/abs/2311.01545, these differs from the one that can be found in chemicalmotifidentifier/_src/frameworks_base which are the one used in ``Chemical-motif chacacterization of SRO with E(3)-equivariant GNN''
...
class ECASyntheticFirstPaper(ECA_Synthetic):
    ...
    def import_model_config(self):
        ...
        model_config = {
            ...
            "model_load": "../doi-10.48550-arXiv.2311.01545.pt",
            "mul": 50,  # 50
        }
...
class ECA_MD_FirstPaper(ECA_MD):
    ...
    def import_synthetic(self):
        ...
        self.df_synthetic = pd.read_pickle(
            f"/home/ksheriff/PAPERS/first_paper/02_1nn_synthetic/data/analysis/df_{self.crystal_structure}.pkl"
        )
